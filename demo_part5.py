...
# =================================================== Part 5 =======================================================
print "Part 5: Optimizing on non-stationary historical data, with rolling estimate."
...
print "training pnl = ", training_pnl
...
ax1.set_title("Part 5 - In-sample P&Ls")
ax2.plot(out_samplePnLs)
ax2.set_title("Part 5 - Out-of-sample P&Ls")
plt.show()
